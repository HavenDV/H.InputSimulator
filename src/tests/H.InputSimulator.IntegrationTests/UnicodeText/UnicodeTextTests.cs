...
namespace WindowsInput.Tests.UnicodeText
{
    ...
    {
        public TestCaseData[] UnicodeTestCases { get; } = 
            Array.ConvertAll(GetUnicodeRanges(), BuildTestCase);

        private static TestCaseData BuildTestCase(UnicodeRange input)
        {
        ...
        public static UnicodeRange[] GetUnicodeRanges()
        {
            return new[]
                       {
